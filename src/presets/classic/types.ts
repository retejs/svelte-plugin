...
export type SvelteArea2D<T extends ClassicScheme> =
...
export type ExtractPayload<T extends ClassicScheme, K extends string> = Extract<SvelteArea2D<T>, { type: 'render', data: { type: K } }>['data']
